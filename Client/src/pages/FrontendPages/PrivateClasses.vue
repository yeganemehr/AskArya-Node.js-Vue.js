          ...
          <div class="col-lg-4 col-sm-12 px-2">
            <div class="pricing-box hover">
              ...
              <div class="pricing-field">
                ...
                <p class="smalltext">گروهی - ۵ جلسه</p>
              </div>
              <div class="pricing-features pt-3">
                <ul>
                  <li class="bold">ظرفيت ٤ الی ۶ نفر</li>
                  <li>تمرین مکالمه</li>
                  <li>تمرین لیسنینگ</li>
              ...
              <div class="pricing-action">
                <a href="https://t.me/AskAryaSomething">
                  <b-button block class="btn">رزرو کلاس</b-button>
                </a>
              </div>
            </div>
          </div>
...
export default {
  metaInfo: {
    title: 'اسک آریا | کلاس های خصوصی',
    titleTemplate: 'اسک آریا | کلاس های خصوصی',
    htmlAttrs: {
      lang: 'fa',
      amp: true,
    },
...
.btn:hover {
  background: #b61439 !important;
  border: 1px solid #b61439;
  color: #fff;
}
