        ...
        <div class="row pricing">
          ...
          <div class="col-lg-4 col-sm-12 px-3">
            <div class="pricing-box hover">
              ...
              <div class="pricing-field">
                <p class="price">۲,۰۰۰,۰۰۰ <span class="toman">تومان</span></p>
                <p class="py-0 my-0 smalltext">۱۰ جلسه</p>
              </div>
              <div class="pricing-features pt-3">
                <ul>
                  <li>تمرین مکالمه</li>
          ...
          <div class="col-lg-4 col-sm-12 px-3">
            <div class="pricing-box hover">
              ...
              <div class="pricing-field">
                ...
                <p class="py-0 my-0 smalltext">۱۶ جلسه</p>
              </div>
              <div class="pricing-features pt-3">
                <ul>
                  <li>تمرين مكالمه</li>
