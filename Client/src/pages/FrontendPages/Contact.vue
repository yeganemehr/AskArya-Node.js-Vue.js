  ...
  <div class="bg">
    <div class="contactSection">
      ...
      <div class="container-fluid text-center pt-4">
        <!--Intro Section-->
        <div class="introSection pt-4">
          <h1 class="text-white pt-2">تماس با ما</h1>
        ...
        <div class="row">
          ...
          <div class="col-md-6 iconSection text-right pr-5 pt-4">
            <p class="lead pt-4">
              <i class="fab fa-telegram ml-4 icon-text"></i>
              <a href="https://t.me/AskAryaSomething" class="li-ic">AskAryaSomething@</a>
            </p>
            <p class="lead pt-4 text-rtl">
              <i class="fa fa-phone ml-4 icon-text"></i>
              <a href="tel:+989032227796" class="fb-ic">09032227796</a>
            </p>
            <p class="lead pt-4">
              <i class="fa fa-envelope ml-4 icon-text"></i>
