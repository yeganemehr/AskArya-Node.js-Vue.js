<template>
  <div>
    ...
    <div class="bg">
      <!--Stats Section-->
      <div class="Stats-section-homepage py-5">
        <Stats></Stats>
      </div>
      <!--Founder Section-->
...
.hero-content-homepage {
  ...
  background: linear-gradient(90deg, #683bbd8e, #b300faa1),
...
.border-long-dash {
  ...
  -o-border-image: url(/img/frontend/long-dash-border.svg) 1 round;
  border-image: url(/img/frontend/long-dash-border.svg) 1 round;
  padding-left: 0.5rem;
