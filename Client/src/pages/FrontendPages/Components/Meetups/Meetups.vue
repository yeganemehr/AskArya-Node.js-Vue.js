  ...
  <div>
    <div class="container">
      <div class="row">
        ...
        <!-- <div class="previousMeetups px-4 col-md-5 col-sm-12 text-center">
          <h3 class="subheading2 mb-5">Previous Meetups</h3>
          <img
            src="~assets/img/airportmeetup-askarya.png"
            width="220px"
            alt="Ask Arya Meetups"
            class="img-fluid"
          >
          <img
            src="~assets/img/artmuseummeetup-askarya.png"
            width="220px"
            alt="Ask Arya Meetups"
            class="py-3 img-fluid"
          >
          <img
            src="~assets/img/darbandmeetup-askarya.png"
            width="220px"
            alt="Ask Arya Meetups"
            class="py-3 img-fluid"
          >
          <img
            src="~assets/img/qeytariyemeetup-askarya.png"
            width="220px"
            alt="Ask Arya Meetups"
            class="py-3 img-fluid"
          >
