  ...
  <div class="blogBox">
    <router-link to="/">
      <div class="card">
        <img
          class="card-img-top"
          src="/img/frontend/sympathy-askarya.png"
          alt="sympathy expressions blog post image"
        >
        <div class="category">General</div>
        <div class="card-body">
          <h3 class="card-title py-2">Expressions of sympathy.</h3>
          <div class="d-flex justify-content-between">
            29 June 2018
            <span>
              <i class="fa fa-eye"></i> 40862 views
            </span>
          </div>
        </div>
      </div>
