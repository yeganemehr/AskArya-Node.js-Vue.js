  ...
  <div class="blogBox">
    <router-link to="/">
      <div class="card">
        <img
          class="card-img-top"
          src="/img/frontend/givingdirections-askarya.png"
          alt="how to give and ask directions blog post image"
        >
        <div class="category">General</div>
        <div class="card-body">
          <h3 class="card-title py-2">Giving & Asking for Directions.</h3>
          <div class="d-flex justify-content-between">
            10 July 2018
            <span>
              <i class="fa fa-eye"></i> 69502 views
            </span>
          </div>
        </div>
      </div>
