  ...
  <div class="blogBox">
    <router-link to="/">
      <div class="card">
        <img
          class="card-img-top"
          src="/img/frontend/abbreviations-askarya.png"
          alt="top abbreviations blog post image"
        >
        <div class="category">General</div>
        <div class="card-body">
          <h3 class="card-title py-2">Top English Abbreviations.</h3>
          <div class="d-flex justify-content-between">
            01 August 2018
            <span>
              <i class="fa fa-eye"></i> 41968 views
            </span>
          </div>
        </div>
      </div>
