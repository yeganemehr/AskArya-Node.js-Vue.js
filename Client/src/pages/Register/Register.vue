<template>
  <section class="bg">
    <div class="container">
      <div class="row">
        <div class="d-flex align-items-center justify-content-center pt-5 px-3 mr-auto ml-auto">
            ...
            <form @submit="checkForm" id="register-form">
              <div class="row pt-3">
                <div class="col-md-12 text-ltr">
                  ...
                  <base-input v-model="name" :required="true" :error="fieldErrors.name"></base-input>
                </div>

                <div class="col-md-12 text-ltr">
                  <label class="pull-right pt-2">پست الکترونیک</label>
                  <base-input v-model="email" :required="true" :error="fieldErrors.email"></base-input>
                </div>
              ...
              <div class="row d-flex justify-content-around">
                <div class="text-center pb-3">
                  ...
                  <p
                    class="px-5 google-text"
                  >شما میتوانید بدون ثبت نام با اکانت گوگل وارد سایت شوید.</p>
                </div>
              </div>
