    ...
    <router-link to="singlecourse">
      <div class="hover m-widget7 m-widget7--skin-dark widget-3">
        <div class="m-widget7__courseimage">
          <img class="m-widget7__courseimage" src="/img/GeneralGrammarCourse.png">
        </div>
        <div class="course__name">
          <h4 class="text-center pt-3">General Grammar Course</h4>
        </div>
        <div class="m-widget7__user">
          ...
          <div class="m-widget7__info">
            ...
            <br>
            <span class="m-widget7__time">04/01/2019</span>
          </div>
        </div>
        <hr class="fadeline">
        <div class="bottom price d-flex justify-content-between px-4 pb-3">
          <div>
            <p class="pricehighlight">
              <i class="tim-icons icon-money-coins pr-2"></i>149,000 Tomans
            </p>
          </div>
          <div>
            <p>
              <i class="tim-icons icon-watch-time pr-2"></i>31:34:12
            </p>
          </div>
        </div>
      </div>
